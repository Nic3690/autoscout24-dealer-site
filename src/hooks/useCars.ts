 ...
 */
export function useCars(filters: CarFilters, page = 1, limit = 20) {
  return useQuery({
    queryKey: carQueryKeys.list({ ...filters, page, limit } as any),
 ...
 */
export function useLuxuryCars(filters: Omit<CarFilters, 'isLuxury'> = {}, page = 1, limit = 20) {
 ...
 */
export function useRecentCars(limit = 10) {
  return useQuery({
 ...
 */
export function useFeaturedCars(limit = 6) {
  return useQuery({
